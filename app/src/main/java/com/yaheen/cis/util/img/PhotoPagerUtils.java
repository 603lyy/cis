...
import com.yaheen.cis.activity.base.PhotoPagerActivity;
...
public class PhotoPagerUtils {
    ...
    private PhotoPagerUtils(Activity activity, Builder builder) {
...
//            Awen.checkInit();
         ...
         * @return Builder
         */
        public Builder setBigBitmap(Drawable bigBitmap) {
            if (bigBitmap == null) {
                throw new NullPointerException("bigBitmap is null or size is 0");
            }
            photoPagerBean.setBigBitmap(bigBitmap);
            return this;
        }
        ...
        public PhotoPagerUtils build() {
            return new PhotoPagerUtils(context, this);
        }
    }
