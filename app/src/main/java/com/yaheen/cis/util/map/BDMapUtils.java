package com.yaheen.cis.util.map;
...
public class BDMapUtils {
    ...
    private static MapViewLocationListener locationListener;
    ...
    public static void setMapViewListener(MapViewLocationListener listener) {
        locationListener = listener;
    }

    public static void removeMapViewListener() {
...
//        可选，设置是否当GPS有效时按照1S / 1 次频率输出GPS结果，默认false
    ...
    private static class MyLocationListener extends BDAbstractLocationListener {
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            if (locationListener != null) {
                locationListener.changeLocation(location);
            }
